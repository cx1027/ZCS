...
//
//		Point xy = env.getCurrentLocation();
...
//			System.out.println("x:y:" + env.getCurrentLocation());
//
//			// main loop
//			while (true && count < 50) {
...
//					count++;
//					s3 = new StepSnapshot(xy, env.getCurrentLocation(), count, path);
//					// env.resetPosition();
...
//					System.out.println("***move to State:" + "x:y:" + env.getCurrentLocation() + "****###nextTarget:" + TA);
//					count++;
//					path.add(env.getCurrentLocation());
//				}
//			}
//		}
//		// cannot reach to final state within 50 steps above
//		if (s3 == null) {
//			s3 = new StepSnapshot(xy, env.getCurrentLocation(), -1, path);
//		}
//		return s3;
//	}
//
...
////							(int) maze.getCurrentLocation().getX(), (int) maze.getCurrentLocation().getY()));
//				}
//
//				// cannot reach to final state within 50 steps above
//				if (s3 == null) {
//					s3 = new StepSnapshot(startPos, env.getCurrentLocation(), -1, path);
//					ret.add(s3);
...
//		// maze.getCurrentLocation().getX(), (int) maze.getCurrentLocation().getY())));
//		return ret;
//	}
//
...
//				int stepAction = -1;
//
//				Point prev = maze.getCurrentLocation();
